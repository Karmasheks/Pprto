...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
      <Helmet>
        <title>Вход - МаркетМетрикс</title>
        <meta name="description" content="Войдите в свой аккаунт МаркетМетрикс для доступа к аналитической панели производительности маркетинговой команды." />
      </Helmet>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-8">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          Мониторинг эффективности вашей маркетинговой команды
        </p>
      </div>
